    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        try:
            ...
            resp.text = MethodResponse(req,
                            DriverException(0x500, 'Safetymonitor.Connect failed', ex)).json
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            ...
            resp.text = MethodResponse(req, # Put is actually like a method :-(
                            DriverException(0x500, 'Safetymonitor.Connected failed', ex)).json
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        try:
            ...
            resp.text = PropertyResponse(None, req,
                            DriverException(0x500, 'Safetymonitor.Connecting failed', ex)).json
...
class disconnect:
    def on_put(self, req: Request, resp: Response, devnum: int):
        try:
            ...
            resp.text = MethodResponse(req,
                            DriverException(0x500, 'Safetymonitor.Disconnect failed', ex)).json
